...
export const ProgramList = () => {
  const programs: ProgramContainerProps["program"][] = [
    {
      name: "FBS",
      description: "FCM FOUNDATION BOARD SCHOLARSHIP ",
      link: "/programs/fbs",
      isCurrent: true,
      startDate: "Sept. 1st, 2024",
      endDate: "Sept. 25th, 2024",
      badge: "New",
    },
    {
      name: "ULSP",
  ...
  return (
    <div className="sm:mx-24 m-12">
      <div>
        <h1 className="text-5xl text-purple-900 font-semibold mb-5 text-center underline">
          Our Programs
        </h1>
        <div className="flex gap-5 mb-5">
          {tabs.map((tab, index) => (
            <h1
              key={index}
              className={`text-3xl font-extrabold cursor-pointer hover:underline hover:text-purple-500 ${
                activeTab === tab
                  ? "text-purple-500 underline hover:text-grey-500"
                  : "text-gray-500"
              }`}
