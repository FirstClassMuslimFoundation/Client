...
export const About = () => {
    const [selectedTab, setSelectedTab] = useState(''); // State to manage the selected tab text
    ...
    return (
        <div style={{ background: '#FFFFBF'}} className="flex justify-center">
            <div className="justify-center">
                <h1 className="text-4xl font-bold p-8 text-center hover:underline transition-transform transform hover:scale-110">About Us</h1>
